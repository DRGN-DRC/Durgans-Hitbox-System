masterListArchive.splice(overridePosition, 0, new Array ("CharName",
        			 ...
        			 ["Forward Air|", "", "Duration|", "Hit|", "Damage|%", "IASA|", "Auto-cancel|<img src='Parts Bin/fA.png' />&nbsp;, &nbsp;<img src='Parts Bin/fA.png' class='flipIMG-x' />", "Landing Lag|", "L-canceled Lag|", ""],
        			 ...
        			 ["Dash Attack|", "", "Duration|", "Hit|", "Damage|%", "IASA|", ""],
        			 ...
        			 ["Characteristics|", "", "Weight|", "Shield Release Lag|", ""]
...
function destinationCheck() { // The variable "destinationLock" is a flag for which character/move pair to look at and where to display the data. (Set by the appendData function.)
		...
		dataReconstitutor("CharName", specificChar, specificMove, destination); 
}
